...
<html>
    <head>
        ...
        <title>SigBod - Informacion Orden de Compra</title>
        <script type="text/javascript">
            function buscarCod() {
                ...
                if (indices.length < 2) {
                    ...
                    cart.action = "../edicion/decodeJsonOC.php?op=1";
                    cart.submit();
                }
            }
        </script>
    ...
    <body class="fondo">
        <form id="cart" name="cart" method="GET" onsubmit= "return buscarCod()">
            <table class="table">
                <tr>
                    <td class="texto" colspan="2">Buscar Detalle de Orden de Compra</td>
                </tr>
                <tr>
                    <td class="texto1">Ingrese ID a Buscar:</td>
                    <td><input type="text" name="oc" id="txtcod" class="texto6" autofocus size="20" maxlength="18" onkeypress="if (event.keyCode == 13)
