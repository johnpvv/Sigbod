...
<html>
    <head>
        ...
        <title>SigBod - Buscar Seguimiento</title> 
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#buscar").click(function (e) {//comprobamos si se pulsa una tecla 
                    ...
                    var chkest = $("#checkest").prop("checked");
                    $.ajax({//hace la busqueda
                        type: "POST",
                        url: "buscarSeguimientoAjax.php",
                        data: {b: consulta, chkall: chkall, chkrev: chkrev, chkest: chkest},
                        beforeSend: function () {
                            $.blockUI({
    ...
    <body class="fondo" onload="buscar.click();">
        <table class="table2a">
            <tr>
                <td class="texto">Buscar Seguimiento de Documentos</td>
            </tr>
            <tr>
                <td class="texto1"><center>Ingrese Nombre a Buscar:&nbsp;<span class="texto5a"><input id="busqueda" name="txtnom" type="search" placeholder="escriba aqui..." autofocus size="30" class='caja' onkeypress="if (event.keyCode == 13)
                    ...
                    <input type="checkbox" name="checkall" id="checkall" <?= $chktodo ?>/> Mostrar Todos&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="checkrev" id="checkrev" <?= $chkrev ?>/> Seguimientos Vencidos&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="checkest" id="checkest" /> Incluir Cerrados
                </span> </center>
        </td>
    </tr>        
    <tr>
