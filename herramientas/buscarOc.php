...
<html>
    ...
    <body class="fondo">        
        <table class="table2a">
            <tr>
                <td class="texto">Consultar Ordenes de Compra</td>
            </tr>
            <tr>
                <td class="texto5b">
    ...
    <tr>
        ...
        <button onclick="window.location = '../exportar/exportaExcelOc.php'" class="botonnormal">Exportar a Excel&nbsp;&nbsp;<img class='img' alt='exportar' title='Exportar a Excel los datos mostrados en pantalla' src='../img/excel3.png'></button>&nbsp;&nbsp;&nbsp;&nbsp;
		<button onclick="window.location = 'crearOc.php'" class="botonnormal">Ir a Crear OC&nbsp;&nbsp;<img class='img' alt='Crearoc' title='Ir a la pantalla de Crear OC' src='../img/oc.png'></button></center></td>
</tr>
</table>
