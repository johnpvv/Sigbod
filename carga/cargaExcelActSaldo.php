...
<html>
    <head>
        <title>SigBod - Actualizar Saldos Orden de Compra</title>
        ...
        <script type="text/javascript">
            $(document).ready(function (e) {
                $("#cargaActSaldo").on('submit', (function (e) {
                    e.preventDefault();
                    var data = new FormData(this); // <-- 'this' is your form element
                    $.ajax({
                        url: 'cargaExcelActSaldoAjax.php',
                        data: data,
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        beforeSend: function () {
                            $.blockUI({
                                message: "<p class='centrar_cuadro_alertas'>Cargando Archivo, por favor espere...<img src='../img/ajax-loading.gif' width='270' height='180' /></p>"
                            });
                        },
                        error: function () {
    ...
    <body class="fondo">
        <form id='cargaActSaldo' method='post' enctype="multipart/form-data">
            <table class="table2">
                <tr>
                    <td class="texto">Actualizar Saldos de Orden de Compra con Recepciones</td>
                </tr>
                <tr>
