...
<html>
    ...
    <body class="fondo">
        <form id="cargaProd" method='post' enctype="multipart/form-data">
            <table class="table2">
                <tr>
                    <td class="texto">Carga/Modificación Masiva de PAC</td>
                </tr>
                <tr>
