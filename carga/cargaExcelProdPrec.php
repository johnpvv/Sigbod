...
<html>
    <head>
        <title>SigBod - Cargar Precios y glosas de Productos</title>
        ...
        <script type="text/javascript">
            $(document).ready(function (e) {
                $("#cargaProd").on('submit', (function (e) {
                    e.preventDefault();
                    var data = new FormData(this); // <-- 'this' is your form element
                    $.ajax({
                        url: 'cargaExcelProdPrecAjax.php',
                        data: data,
                        cache: false,
                        contentType: false,
                        processData: false,
    ...
    <body class="fondo">
        <form id="cargaProd" method='post' enctype="multipart/form-data">
            <table class="table2">
                <tr>
                    <td class="texto">Carga Masiva de Precios y Glosas de Productos</td>
                </tr>
                <tr>
