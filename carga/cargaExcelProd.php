...
<html>
    <head>
        <title>SigBod - Cargar Productos</title>
    ...
    <body class="fondo">
        <form id="cargaProd" method='post' enctype="multipart/form-data">
            <table class="table2">
                <tr>
                    <td class="texto">Carga Masiva de Productos</td>
                </tr>
                <tr>
