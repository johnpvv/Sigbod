...
<html>
    <head>
        <title>SigBod - Cargar Documentos</title>
    ...
    <body class="fondo">
        <form id='cargaDoc' method='post' enctype="multipart/form-data">
            <table class="table2">
                <tr>
                    <td class="texto">Carga Masiva de Documentos</td>
                </tr>
                <tr>
