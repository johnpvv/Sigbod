...
<html>
    <head>
        ...
        <title>SigBod - Detalle Licitaciones (beta)</title>
    </head>
    <body class="fondo">
        <table class="table3" align="center">
            <tr><td class="texto"><img class="imgico" alt='OC' title='OC' src='../img/mp1.png'>&nbsp;&nbsp;&nbsp;Información Avanzada Licitación N° <?= $id ?></td></tr>            
        </table>
