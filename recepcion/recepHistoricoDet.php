...
<html>
    ...
    <body class="fondo">        
        <table class="table2a">
            <tr>
                <td class="texto">Consultar Detalle Recepciones Históricas (beta)</td>
            </tr>
            <tr>
                <td class="texto1">
            ...
            <tr>
				...
				<button onclick="window.location = '../recepcion/recepHistorico.php'" class="botonnormal">Abrir Recepciones&nbsp;&nbsp;<img class='img' alt='link' title='Abrir Modulo recepcion' src='../img/report.png'></button>&nbsp;&nbsp;&nbsp;&nbsp;
		<button onclick="window.location = '../exportar/exportaExcelRecepHistDet.php'" class="botonnormal">Exportar a Excel&nbsp;&nbsp;<img class='img' alt='exportar' title='Exportar a Excel los datos mostrados en pantalla' src='../img/excel3.png'></button>&nbsp;&nbsp;&nbsp;&nbsp;</center></td>
            </tr>
</table>
