...
<html lang="es">
    ...
    <body style="margin: -0.3in 0in 0in 0in;">
        ...
        echo '<tr><td colspan="2" class="texto6"><b>Nombre:</b>&nbsp;&nbsp;' . $row1["usuario_nombre"] . ' ' . $row1["usuario_apellidos"] . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Unidad Solicitante:</b>&nbsp;&nbsp;' . $row1["usuario_institucion"] . '</td></tr>';
        echo '<tr><td colspan="2" class="texto6"><b>Teléfono:</b>&nbsp;&nbsp;' . $row1["usuario_telefono"] . ',&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Email:</b>&nbsp;&nbsp;' . $row1["usuario_email"] . '<br><b>DIRECCIÓN DE ENTREGA PRODUCTOS:</b>&nbsp;&nbsp;' . $row1["usuario_direccion"] .'</td></tr>';
       	echo '</table>';
        echo '<table class="table4">';
